            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10 grid gap-12 md:grid-cols-4">
                ...
                <div>
                    ...
                    <ul className="space-y-4 inter-tt text-sm tracking-widest uppercase text-gray-400">
                        <li><Link to="/shop" className="hover:text-[#ce6400] transition-colors">All oils</Link></li>
                        <li><Link to="/shop" className="hover:text-[#ce6400] transition-colors">Groundnut</Link></li>
                        <li><Link to="/shop" className="hover:text-[#ce6400] transition-colors">Sesame</Link></li>
                        <li><Link to="/shop" className="hover:text-[#ce6400] transition-colors">Coconut</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-4 inter-tt text-sm tracking-widest uppercase text-gray-400">
                        <li><Link to="/heritage" className="hover:text-[#ce6400] transition-colors">Our heritage</Link></li>
                        <li><Link to="/contact" className="hover:text-[#ce6400] transition-colors">Contact</Link></li>
                        <li><Link to="/policies" className="hover:text-[#ce6400] transition-colors">Policies</Link></li>
                    </ul>
                </div>
            </div>
